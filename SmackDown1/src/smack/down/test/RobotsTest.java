...
public class RobotsTest {
	...
	public void testTechCenter() {
		Player player1 = new Player("TestPlayer1", new Deck(new ArrayList<DeckCard>(Arrays.asList(
		...
		Minion m1 = (Minion) new Minion("TestMinion1", Faction.Dinosaurs, 1).setOwner(player1);
		Minion m2 = (Minion) new Minion("TestMinion2", Faction.Dinosaurs, 1).setOwner(player1);
		Minion m3 = (Minion) new Minion("TestMinion3", Faction.Ninjas, 1).setOwner(player1);
		Minion m4 = (Minion) new Minion("TestMinion4", Faction.Pirates, 1).setOwner(player1);
		Minion m5 = (Minion) new Minion("TestMinion5", Faction.Tricksters, 1).setOwner(player1);
		Minion m6 = (Minion) new Minion("TestMinion6", Faction.Tricksters, 1).setOwner(player1);
		Minion m7 = (Minion) new Minion("TestMinion7", Faction.Wizards, 1).setOwner(player2);
		Minion m8 = (Minion) new Minion("TestMinion8", Faction.Wizards, 1).setOwner(player2);
		Minion m9 = (Minion) new Minion("TestMinion9", Faction.Zombies, 1).setOwner(player2);
